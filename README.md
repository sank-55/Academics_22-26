...
<li><strong>Sem 4:</strong> Transform Calculus, Mechatronics*, Basic Thermodynamics, Operation Research, Materials Processing ( add.)</li>
...
<li><strong>Sem 7:</strong> Applied Elasticity, Fabrication and Manufacturing of Advanced Composites , Soft Computing, IC engine,Numerical Modelling ,SysCon , BTP - I </li>
